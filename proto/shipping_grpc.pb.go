...
type ShippingServiceClient interface {
	StartShipping(ctx context.Context, in *ShippingRequest, opts ...grpc.CallOption) (*ShippingResponse, error)
}
...
func (c *shippingServiceClient) StartShipping(ctx context.Context, in *ShippingRequest, opts ...grpc.CallOption) (*ShippingResponse, error) {
...
type ShippingServiceServer interface {
	StartShipping(context.Context, *ShippingRequest) (*ShippingResponse, error)
...
func (UnimplementedShippingServiceServer) StartShipping(context.Context, *ShippingRequest) (*ShippingResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method StartShipping not implemented")
}
...
func _ShippingService_StartShipping_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ShippingServiceServer).StartShipping(ctx, req.(*ShippingRequest))
	}
